...
const create_gallery_dto_1 = require("../dtos/create-gallery.dto");
const update_gallery_dto_1 = require("../dtos/update-gallery.dto");
...
], AdminGalleryController.prototype, "getList", null);
__decorate([
    (0, common_2.Permission)('introduction.manage'),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], AdminGalleryController.prototype, "getOne", null);
__decorate([
    (0, common_2.Permission)('introduction.manage'),
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], AdminGalleryController.prototype, "create", null);
__decorate([
    (0, common_2.Permission)('introduction.manage'),
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], AdminGalleryController.prototype, "update", null);
__decorate([
    (0, common_2.Permission)('introduction.manage'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminGalleryController.prototype, "delete", null);
exports.AdminGalleryController = AdminGalleryController = __decorate([
    (0, swagger_1.ApiTags)('Admin Galleries'),
    (0, common_1.Controller)('admin/galleries'),
    __metadata("design:paramtypes", [gallery_service_1.AdminGalleryService])
