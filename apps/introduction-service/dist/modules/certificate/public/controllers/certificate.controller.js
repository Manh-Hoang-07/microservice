...
exports.PublicCertificateController = void 0;
...
], PublicCertificateController.prototype, "getList", null);
__decorate([
    (0, common_2.Public)(),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], PublicCertificateController.prototype, "getOne", null);
exports.PublicCertificateController = PublicCertificateController = __decorate([
    (0, swagger_1.ApiTags)('Public Certificates'),
    (0, common_1.Controller)('public/certificates'),
    __metadata("design:paramtypes", [certificate_service_1.PublicCertificateService])
