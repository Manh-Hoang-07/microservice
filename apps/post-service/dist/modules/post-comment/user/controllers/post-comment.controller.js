...
const create_post_comment_dto_1 = require("../dtos/create-post-comment.dto");
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, create_post_comment_dto_1.CreatePostCommentDto]),
    __metadata("design:returntype", Promise)
], UserPostCommentController.prototype, "create", null);
__decorate([
    (0, common_2.Permission)('user'),
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", Promise)
], UserPostCommentController.prototype, "update", null);
__decorate([
    (0, common_2.Permission)('user'),
...
exports.UserPostCommentController = UserPostCommentController = __decorate([
    (0, swagger_1.ApiTags)('User Post Comments'),
    (0, common_1.Controller)('user/post-comments'),
    __metadata("design:paramtypes", [post_comment_service_1.UserPostCommentService])
