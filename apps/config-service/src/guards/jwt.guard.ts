...
/**
 * JwtGuard — used for microservices (Config, Storage, BFF, etc.)
 * Verifies JWT using JWKS public key from Auth Service.
 * When AUTH_JWKS_URL is not set (local dev), the guard bypasses authentication.
 */
@Injectable()
export class JwtGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Internal route → skip JWT, InternalGuard handles secret check separately
