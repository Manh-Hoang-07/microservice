...
(0, tracing_1.initTracing)('comic-service');
...
async function bootstrap() {
    ...
    if (process.env.NODE_ENV !== 'production') {
        const doc = new swagger_1.DocumentBuilder()
            .setTitle('Comic Service')
            .setDescription('Comic domain microservice — Comic Platform')
            .setVersion('1.0')
    ...
    console.log(`Comic Service running on http://localhost:${port}/${prefix}`);
}
bootstrap().catch((err) => {
