...
(0, tracing_1.initTracing)('marketing-service');
...
async function bootstrap() {
    ...
    if (process.env.NODE_ENV !== 'production') {
        const doc = new swagger_1.DocumentBuilder()
            .setTitle('Marketing Service')
            .setDescription('Marketing domain microservice — Comic Platform')
            .setVersion('1.0')
    ...
    console.log(`Marketing Service running on http://localhost:${port}/${prefix}`);
}
bootstrap().catch((err) => {
